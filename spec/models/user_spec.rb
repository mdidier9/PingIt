...
describe User do
  ...
  context "active_pinga_markers" do
    it "should return Gmaps4rails object" do
      expect(user.active_pinga_markers).to be_a_kind_of(Gmaps4rails)
    end
  end

  context "pending_pinga_markers" do
    it "should return Gmaps4rails object" do
      expect(user.pending_pinga_markers).to be_a_kind_of(Gmaps4rails)
    end
  end

  context "grey_pinga_markers" do
    it "should return Gmaps4rails object" do
