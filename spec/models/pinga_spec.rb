...
describe Pinga do
  ...
  let (:pinga) {Pinga.new(title: "Title", description: "desc", status: "pending", start_time: Time.new, end_time: Time.new, address: "address here", latitude: 80.423542, longitude: 400.854903543, creator_id: 5)}
