...
# out of range
Pinga.create!(title: "Sport town", description: "Play the game", status: "pending", start_time: Time.now+1000, end_time: Time.now, address: "630 N Kingsbury St Chicago, IL 60654", creator_id: 1, category: sports)
...
Pinga.create!(title: "Three dots and a dash", description: "This sounds like a bar", status: "active", start_time: Time.now-500, end_time: Time.now, address: "435 N Clark St Chicago, IL 60654", creator_id: 1, category: entertainment)

Pinga.create!(title: "Flash Mob", description: "I don't get these things", status: "pending", start_time: Time.now+500, end_time: Time.now, address: "220 E Chicago Ave Chicago, IL 60611", creator_id: 1, category: social)

Pinga.create!(title: "Rubies meets up", description: "'Grammin at a hotel", status: "pending", start_time: Time.now+1000, end_time: Time.now, address: "111 W Huron St Chicago, IL 60654", creator_id: 1, category: social)
