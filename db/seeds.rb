...
Pinga.create!(title: "Chipotle Meetup Free Burritos", description: "This is crazy", status: "pending", start_time: Time.now+6000, address: "233 W Lake St Chicago, IL 60606", creator_id: 1, category: food, duration: 1)

Pinga.create!(title: "Hot Shopping Deals Everything $1", description: "Which one is this again?", status: "active", start_time: Time.now-1000, address: "304 W Hubbard St Chicago, IL 60654", creator_id: 1, category: deals, duration: 1)

Pinga.create!(title: "Movie in the Park", description: "Everyone get together and watch a movie", status: "active", start_time: Time.now-500, address: "435 N Clark St Chicago, IL 60654", creator_id: 1, category: entertainment, duration: 1)

Pinga.create!(title: "Flash Mob", description: "I don't get these things", status: "pending", start_time: Time.now+500, address: "220 E Chicago Ave Chicago, IL 60611", creator_id: 1, category: entertainment, duration: 1)
